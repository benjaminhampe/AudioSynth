#ifndef DE_BENNI_ASSIMP_TOOLS
#define DE_BENNI_ASSIMP_TOOLS
...
namespace gpu {
   ...
   struct AssimpTools
   {
      ...
      */
      ...
      static bool
      parseMaterial( aiScene const * const assimpScene, uint32_t matIndex, SMaterial & out, IVideoDriver* driver, std::string baseDir );
