#ifndef DE_GPU_CANVAS3D_QWIDGET_HPP
#define DE_GPU_CANVAS3D_QWIDGET_HPP
...
#include <DarkGPU.hpp>
#include <de/gpu/scene/GridSceneNode.hpp>

struct Canvas3D : public QWidget
{
   Q_OBJECT
public:
...
public:
   ...
   de::gpu::scene::GridSceneNode* m_GridSceneNode;
