#ifndef DE_AUDIO_DECODER_FFMPEG_HPP
#define DE_AUDIO_DECODER_FFMPEG_HPP
...
typedef std::function< void(Payload const &) > ON_AUDIO_PAYLOAD;
...
// ===========================================================================
{
   ...
   static uint64_t
   extractAudio( AVFrame* avFrame, Payload & payload, bool debug = false );
