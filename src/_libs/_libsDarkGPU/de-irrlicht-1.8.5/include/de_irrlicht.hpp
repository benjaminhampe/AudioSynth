...
template < typename T > std::ostream& operator<< ( std::ostream& o, irr::core::vector2d< T > const & v ) 
{ o << v.X << "," << v.Y; return o; }

template < typename T > std::ostream& operator<< ( std::ostream& o, irr::core::vector3d< T > const & v ) 
{ o << v.X << "," << v.Y << "," << v.Z; return o; }

inline std::ostream & operator<< ( std::ostream& o, irr::video::SColor const & color )
{ o << color.getRed() << "," << color.getGreen() << "," << color.getBlue() << "," << color.getAlpha(); return o; }

inline std::ostream & operator<< ( std::ostream& o, irr::core::dimension2du const & d )
{ o << d.Width << "," << d.Height; return o; }

inline std::ostream & operator<< ( std::ostream& o, irr::core::recti const & r )
{ o << r.UpperLeftCorner.X << "," << r.UpperLeftCorner.Y << "," << r.getWidth() << "," << r.getHeight(); return o; }

inline std::ostream & operator<< ( std::ostream& o, irr::video::S3DVertex const & v )
{ o << v.Pos << "," << v.Normal << "," << v.Color << "," << v.TCoords; return o; }

inline irr::core::recti mkRect( int32_t x, int32_t y, irr::core::dimension2du size )
{
   return irr::core::recti( irr::core::position2di( x, y ), size );
}

inline irr::core::recti mkRect( int32_t x, int32_t y, int32_t w, int32_t h )
{
