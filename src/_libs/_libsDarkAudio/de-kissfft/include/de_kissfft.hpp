#ifndef DE_KISSFFT_HPP
#define DE_KISSFFT_HPP
...
struct KissFFT
{
   ...
   typedef std::vector< TComplex > TComplexNumbers;

   KissFFT( uint32_t fftSize, bool inverse )
      : m_fftSize( fftSize )
      , m_inverse( inverse )
      , m_fft( fftSize, inverse )
   {
...
//      }
   ...
   bool m_inverse;
   kissfft< T > m_fft;
   TComplexNumbers m_fftInput;
   TComplexNumbers m_fftOutput;
