...
bool
SampleBufferLAME::save( SampleBuffer const & src, std::string uri, SB_SaveOptions const & options )
{
...
//   DE_FLUSH
   ...
   SampleBuffer convBuf( ST_F32I, 2, src.getSampleRate(), chunkFrames );

   //SampleBuffer tmp( ST_F32I, 2, src.getSampleRate(), chunkFrames );
