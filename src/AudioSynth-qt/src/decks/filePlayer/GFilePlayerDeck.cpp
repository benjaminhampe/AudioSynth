...
void
GFilePlayerDeck::on_menuButton_bypass(bool checked)
{
   //m_isBypassed = checked;
}

void
GFilePlayerDeck::on_menuButton_more(bool checked)
{
...
void
GFilePlayerDeck::on_menuButton_hideAll(bool checked)
{
   if ( checked )
   {
...
uint64_t
GFilePlayerDeck::readSamples( double pts, float* dst, uint32_t dstFrames, uint32_t dstChannels, uint32_t dstRate )
{
