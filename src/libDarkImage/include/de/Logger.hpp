...
#ifndef DE_LOGGER_HPP
#define DE_LOGGER_HPP
...
// ===========================================================================
{
   ...
   operator
   ELevel() const { return m_Level; }

   void
   setLevel( ELevel logLevel ) { m_Level = logLevel; }
...
// ===========================================================================
   ...
   #ifndef DE_TRACE
   #define DE_TRACE(...) { getLogger().trace( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getLogger().endl(); }
   #endif
   #ifndef DE_DEBUG
   #define DE_DEBUG(...) { getLogger().debug( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getLogger().endl(); }
   #endif
   #ifndef DE_INFO
   #define DE_INFO(...) { getLogger().info( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getLogger().endl(); }
   #endif
   #ifndef DE_WARN
   #define DE_WARN(...) { getLogger().warn( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getLogger().endl(); }
   #endif
   #ifndef DE_ERROR
   ...
   #ifndef DF_TRACE
   #define DF_TRACE(...) { m_Logger.trace( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); m_Logger.endl(); }
   #endif
   #ifndef DF_DEBUG
   #define DF_DEBUG(...) { m_Logger.debug( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); m_Logger.endl(); }
   #endif
   #ifndef DF_INFO
   #define DF_INFO(...) { m_Logger.info( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); m_Logger.endl(); }
   #endif
   #ifndef DF_WARN
   #define DF_WARN(...) { m_Logger.warn( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); m_Logger.endl(); }
   #endif
   #ifndef DF_ERROR
   ...
   #ifndef DEM_TRACE
   #define DEM_TRACE(...) { getMainLogger().trace( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getMainLogger().endl(); }
   #endif
   #ifndef DEM_DEBUG
   #define DEM_DEBUG(...) { getMainLogger().debug( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getMainLogger().endl(); }
   #endif
   #ifndef DEM_INFO
   #define DEM_INFO(...) { getMainLogger().info( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getMainLogger().endl(); }
   #endif
   #ifndef DEM_WARN
   #define DEM_WARN(...) { getMainLogger().warn( __LINE__, __FILE__, __func__, std::this_thread::get_id() ) << dbStrJoin( __VA_ARGS__ ); getMainLogger().endl(); }
   #endif
   #ifndef DEM_ERROR
...
#endif // DE_HAMPE_COMMON_LOGGING_HPP
